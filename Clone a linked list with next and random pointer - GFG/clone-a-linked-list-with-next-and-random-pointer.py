class Solution:
    def copyList(self, head):
        ...
        # Step 2: Create mapping for 'random' pointers
        original_node = head
        clone_node = clone_head.next
        while original_node is not None and clone_node is not None:
            if original_node.arb:
                clone_node.arb = old_to_new[original_node.arb]
